...
# Variables
lf_bg = 'LightGrey'  # Left Frame Background Color
rtf_bg = 'LightGrey'  # Right Top Frame Background Color
rbf_bg = 'LightGrey'  # Right Bottom Frame Background Color
btn_hlb_bg = 'DarkGrey'  # Background color for Head Labels and Buttons
